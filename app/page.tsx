...
export default async function Home() {
  ...
  // Pastikan listAnimesTrending adalah array yang valid
  const listAnimesTrendingWithBackground = (Array.isArray(listAnimesTrending) ? listAnimesTrending : []).filter(item => item.bannerImage);
